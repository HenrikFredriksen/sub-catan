...
def main():
    ...
    rules = GameRules(board)
     ...
     # Initialize players
    player1 = Player(player_id=0, color=(255, 0, 0), settlements=5, roads=15, cities=4)  # Red player
    player2 = Player(player_id=1, color=(0, 0, 255), settlements=5, roads=15, cities=4)  # Blue player
    player3 = Player(player_id=2, color=(20, 220, 20), settlements=5, roads=15, cities=4)  # Green player
    player4 = Player(player_id=3, color=(255, 165, 0), settlements=5, roads=15, cities=4)  # Orange player
